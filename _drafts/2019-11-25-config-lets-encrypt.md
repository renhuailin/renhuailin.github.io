...
- Either get and install your certificates...
  ...
  http-01 challenge for test.acme.com
...
- If you like Certbot, please consider supporting our work by:
  ...
  打开nginx的配置，我们可以看，certbot添加了如下的内容：
  
  ```nginx
  listen [::]:443 ssl ipv6only=on; # managed by Certbot
  listen 443 ssl; # managed by Certbot
  ssl_certificate /etc/letsencrypt/live/test.acme.com/fullchain.pem; # managed by Certbot
  ssl_certificate_key /etc/letsencrypt/live/test.acme.com/privkey.pem; # managed by Certbot
  include /etc/letsencrypt/options-ssl-nginx.conf; # managed by Certbot
  ssl_dhparam /etc/letsencrypt/ssl-dhparams.pem; # managed by Certbot
  
  #下面这一段是redirect http to https.
  server {
